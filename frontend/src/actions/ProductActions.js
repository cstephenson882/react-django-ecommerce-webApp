...
// redux thunk allows us to return a function within a function
export const listProducts = ( keyword = '', pageNumber = '') => async (dispatch) => {
    try{
        ...
        // 
        // this is the action that will be dispatched the code in the reducer
        dispatch({
...
export const updateProduct = (product) => async (dispatch, getState) => {
    ...
    try {
        ...
        if (data && data._id) {
            ...
            // ✅ Otherwise, re-fetch product details
            dispatch(listProductDetails(product._id))
        }

        // Reset the update state after a successful update
